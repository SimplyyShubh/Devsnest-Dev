...
life_line_list = ['50-50','phone of friend','audience poll']

def user_choice():
     player_choice = input("Enter your choice (player-choice): ")
...
def life_line(index):
    ...
    if len(life_line_list) == 0:
        print("Ded {;-;} you loss your all life lines.")
    else:
        while counter==0:
            ...
            if '50-50' in player_choice:
                ...
                for i in options:
                    if i != correct_answer:
                        ...
                        break
                break
            elif 'phone of friend' in player_choice:
                print("You chooses " + player_choice + "\n")
    ...
    with open('questions.json') as content:
        ...
        while counter <  len(questions['data']):
            ...
            if 'QUIT' in player_choice:
                print("Congramatulations! You Won "+ str(money[counter])  + " Rupess")
                break
            ...
            if 'A' in player_choice or 'B' in player_choice or 'C' in player_choice or 'D' in player_choice:
                ...
                if ans:
                    ...
                    print("")
                    print("Sed{;-;} Your answer is Wrong")
                    print("Anyway congramatulations! You Won "+ str(money[qes_count-1])  + " Rupess")
                    break
                counter +=1
                if counter <=9:
